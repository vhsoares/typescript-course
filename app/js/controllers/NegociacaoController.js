System.register(["../models/index", "../views/index", "../helpers/decorators/index", "../service/index", "../helpers/decorators/imprime"], function (exports_1, context_1) {
    "use strict";
            ...
            NegociacaoController = class NegociacaoController {
                ...
                importaDados() {
                    return __awaiter(this, void 0, void 0, function* () {
                        ...
                        const negociacoesParaImportar = yield this._negociacaoService.getNegociacoes(isOK);
                        negociacoesParaImportar
                            .filter(negociacao => !negociacoesJaImportadas.some(jaImportada => negociacao.isEqual(jaImportada))).forEach(negociacao => this._negociacoes.adicionaNegociacao(negociacao));
                        this._negociacoesView.update(this._negociacoes);
                    });
                }
                isWeekDay(data) {
